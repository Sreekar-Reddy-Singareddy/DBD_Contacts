...
function setFullContact (data) {
    contactJsonMain = data;
}

var exporter = {addCon: addContact, secDetails: insertSecondaryDetails,
    setResponse: setResponse, setId: setId, setFullContact: setFullContact};
